...
import com.smyhvae.radiogrouptabdemo.fragment.XiangjiFagment;
...
public class HomeActivity extends FragmentActivity {
    ...
    private RadioButton mHomeXiangRb;
    private RadioButton mHomeSearchRb;
    private RadioButton mHomeProfileRb;

    static final int NUM_ITEMS = 5;//一共四个fragment
    ...
    protected void initView() {
        ...
        mHomeXiangRb= (RadioButton) findViewById(R.id.mHomexiangji);
